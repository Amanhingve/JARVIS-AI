# offline recognition
# Improved offline speech recognition using Vosk
...
def speech_to_text(prints: bool = True, model_path: str = f"{os.getcwd()}/ASSETS/Vosk/vosk-model-small-en-us-0.15") -> Generator[str, None, None]:
    """
