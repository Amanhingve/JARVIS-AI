...
path = 'BRAIN/auth/samples' # Path for samples already taken

recognizer = cv2.face.LBPHFaceRecognizer_create() # Local Binary Patterns Histograms
detector = cv2.CascadeClassifier("BRAIN/auth/haarcascade_frontalface_default.xml")
...
recognizer.write('BRAIN/auth/trainer/trainer.yml')  # Save the trained model as trainer.yml
